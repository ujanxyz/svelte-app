...
async function editPropsAsync(anchor: HTMLDivElement, initial: string): Promise<string | null> {
  const retValue = await overlayMenu.openOverlayAsync({anchor, lorem: initial});
